...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, securebootuefiQueueInitialize)
#endif

NTSTATUS
securebootuefiQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = securebootuefiEvtIoDeviceControl;
    queueConfig.EvtIoStop = securebootuefiEvtIoStop;
...
VOID
securebootuefiEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
